...
<div> 
	<table cellpadding="10px">  
		<tr>  
			...
			<td><input class="layoutT" type="text" name="user_id" placeholder="BITFARM123" readonly="readonly"></td>
			<td><input class="layoutB" type="button" name="checkId" value="중복확인"></td>
		</tr> 
		<tr>
			<th class="subject">비밀번호*</th>
			<td><input class="layoutT" type="password" name="user_pwd" placeholder="비밀번호를 입력해주세요"></td>
			<td></td>
		</tr>
		<tr>
			<th class="subject">비밀번호확인*</th>
			<td style="padding-top: 2px;"><input class="layoutT" type="password" name="user_repwd" placeholder="비밀번호를 한번 더 입력해주세요"></td>
			<td></td>
		</tr>
		<tr>
			<th class="subject">이름*</th>
			<td><input class="layoutT" type="text" name="user_name" value="김정훈"></td>
			<td></td>
		</tr>
		<tr>
			<th class="subject">이메일*</th>
			<td><input class="layoutT" type="text" name="user_email" value="BITFARM@bitfarm.com" placeholder="예: bitfarm@bitfarm.com"></td>
			<td><input class="layoutB" type="button" name="checkEmail" value="이메일 중복확인"></td>
		</tr>
		<tr>
			<th class="subject">휴대폰*</th>
			<td><input class="layoutT" type="text" name="user_phone" placeholder="숫자만 입력해주세요" value="01011112222"></td> 
			<td></td>
		</tr>
		<tr>
			<th class="subject">배송 주소*</th>
			<td><input class="layoutT" type="text" name="user_address1"></td>
			<td valign="top"><input class="layoutB" type="button" name="checkAddress" value="주소 검색"></td>
		</tr> 
		
		<tr>
			<th class="subject"><p></th>
			<td style="padding-top: 2px;"><input class="layoutT" type="text" name="user_address2"></td>
			<td ></td>
		</tr> 
				
		<tr>
			<th class="subject">생년월일</th>
			<td><input class="layoutT" type="text" placeholder="YYYYMMDD"></td>
			<td></td>
		</tr>
	</table>
</div>
...
<div class="box">
	...
	<div style="weight: 600px; height: 100px; text-align: center;"> 
		<input class="join1" type="button" value="회원탈퇴"> &emsp; 
		<input class="join" type="button" value="수정완료">
	</div>
</form>