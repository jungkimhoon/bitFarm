...
<div>   
	 <h2 align="center">비밀번호 재설정</h2>
		...
		<input class="layout" type="text" id="resetId" name="resetId" style="font-size:15px;" value="${seller_id}" readonly="readonly">
...
<div>  
	 <h2 align="center">비밀번호 재설정</h2>
		<div style="height: 5px"></div>		
		비밀번호  <input class="layout" type="password" id="resetPwd" name="seller_pwd"  style="font-size:15px;">
		<div id="pwdCheck"></div>
		<div style="height: 5px"></div>		
		비밀번호재확인 <input class="layout" type="password" id="resetPwd1" name="seller_repwd"  style="font-size:15px;">
...
$('#resetPwdBtn').click(function(){ 
	if($('#resetPwd').val() == ''){
		...
		$('#repwdCheck').css('font-size','10pt');
		 ...
		 $.ajax({
			 type : 'post',
			 url : '/bitFarm/seller/resetPwd',
			 data : {'seller_id' : '${seller_id}',
				 	'seller_pwd' : $('input[name=seller_pwd]').val()},
			 dataType : 'json',
			 success : function(data){
				 alert("비밀번호 변경완료!");
				 location.href='/bitFarm/seller/sellerLoginForm'; 	  			 
			 }	  		
		});	 
	}   
